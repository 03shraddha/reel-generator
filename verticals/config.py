...
# Load .env from project root (if present) before anything else reads os.environ
...
PLATFORM_CONFIGS: dict[str, dict] = {
    "shorts": {"width": 1080, "height": 1920, "max_script_words": 85, "label": "YouTube Shorts"},
    "reels":  {"width": 1080, "height": 1920, "max_script_words": 85, "label": "Instagram Reels"},
    "tiktok": {"width": 1080, "height": 1920, "max_script_words": 85, "label": "TikTok"},
}
